...
const TranslateScreen = () => {
    ...
    const handleTranslate = () => {
        ...
        axios.post("https://api-inference.huggingface.co/models/gpt2", data, config)
            .then(function (response) {
                ...
                setInput(response.data[0].generated_text)
            })
    ...
    return (
        <View style={styles.container}>
            <TextInput style={{borderWidth:1, height:150, width: 300, padding: 10, marginBottom: 20, borderRadius: 10, fontFamily: 'Cochin', justifyContent:'center', alignItems: 'center'}} placeholder="Type in a sentence"/>
            <FormButton buttonTitle="Translate" onPress={handleTranslate}/>
            ...
            <ScrollView>
                <View style={styles.card}>
                    <View style={styles.cardContent}>
                        <Text style={{fontFamily: 'Cochin'}}>{input}</Text>
                    </View>
                </View>
            </ScrollView>
